...
DXRD.exe is a 64-bit Windows program, which requires blas_win64_MT.dll and lapack_win64_MT.dll that are included in the main folder. The legacy 32-bit program is now renamed DXRD_32bit.exe.
